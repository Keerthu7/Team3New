              ...
              <div className="bg-white p-5 rounded-2xl shadow-xl border border-gray-100 flex flex-col">
                <div className="space-y-5 text-[#28557F]">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="mt-0.5"><h4 className="text-xs font-bold uppercase tracking-widest mb-1 text-gray-500">Digital Inquiry</h4><p className="text-[#28557F] text-sm font-bold leading-relaxed break-all">prabhakar@t3associates.in</p></div>
                  </div>
                </div>
                    ...
                    <div ref={scrollContainerRef} className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide snap-x pr-12 relative z-0" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', scrollBehavior: 'smooth' }}>
                      ...
                      {dates.map((item, idx) => (
                        <button
                          ...
                          className={`flex flex-col items-center justify-center shrink-0 w-[88px] h-[78px] rounded-[16px] border transition-all snap-start ${selectedDate === idx
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {timeSlots.map(time => (
                      <button
                        ...
                        className={`py-3 px-2 rounded-[12px] text-[13px] font-semibold border transition-all ${selectedTime === time
