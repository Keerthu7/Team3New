                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
                                            ...
                                            <div className="lg:col-span-8 space-y-4">
                                                {(formData.technicalDetails?.materials || []).map((m: any, index: number) => (
                                                    <div key={`m-${index}`} className="flex flex-col md:flex-row gap-3 animate-in fade-in slide-in-from-top-2">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
                                            ...
                                            <div className="lg:col-span-8 space-y-4">
                                                {(formData.technicalDetails?.contributors || []).map((m: any, index: number) => (
                                                    <div key={`c-${index}`} className="flex flex-col md:flex-row gap-3 animate-in fade-in slide-in-from-top-2">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
                                            ...
                                            <div className="lg:col-span-8 space-y-4">
                                                {(formData.technicalDetails?.photoCredits || []).map((m: any, index: number) => (
                                                    <div key={`p-${index}`} className="flex flex-col md:flex-row gap-3 animate-in fade-in slide-in-from-top-2">
                                                        <input value={m.label} onChange={(e) => { const v = [...formData.technicalDetails.photoCredits]; v[index].label = e.target.value; setFormData({...formData, technicalDetails: {...formData.technicalDetails, photoCredits: v}}) }} placeholder="E.g. Interior Photography" className="w-full md:flex-1 bg-white border border-[#dfe2ed] rounded-xl h-11 px-4 text-sm focus:border-[#28557F] outline-none font-medium shadow-sm transition-all" />
                                                        <div className="flex gap-3 flex-1">
